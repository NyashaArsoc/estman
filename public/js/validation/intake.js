...
$("#btn-val-new-portfolio").click(function () {
    ...
    try {
        if (portfolioduedateError == true && totalnumberpropertyportfolioError == true &&
            ...
            valuationtypeError == true && clientcontactnameError == true) { return true; }
        else { return false; }
    } catch (err) {
        alert(err.message);
        return false;
...
$("#btn-val-new-portfolio").click(function () {
    ...
    try {
        if (totalnumberpropertyportfolioError == true && valuationpaymentagreementError == true &&
            ...
            portfolioduedateError == true) { return true; }
        else { return false; }
    } catch (err) {
        alert(err.message);
        return false;
...
$("#btn-val-new-property").click(function () {
    validatePropertyClientName();
    try {
        if (propertyclientnameError) { return true; }
        else { return false; }
    } catch (err) {
        alert(err.message);
        return false;
...
$("#btn-val-instr-portfolio-1").click(function () {
    ...
    try {
        if (valuernameError == true && portfolionameError == true) { return true; }
        else { return false; }
    } catch (err) {
        alert(err.message);
        return false;
