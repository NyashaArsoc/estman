...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb no-bg mb-1">
            ...
            <li class="breadcrumb-item"><a href="{{route('landlord.rejected')}}">Rejected</a></li>
        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-material material-primary" id="addlandlord" method="PUT"
                action="{{ route('landlord.editupdate', $id)}}">@csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <textarea type="text" class="form-control" name="ContactAddress" rows="2" cols="3"
                            id="ContactAddress">{{ $landlord->contactaddress ?? ''}}</textarea>
                    </div>
