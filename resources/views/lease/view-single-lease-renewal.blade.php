@php
    $title = 'Renew';
    $description = 'lease renewal details...';
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-material material-primary" action="{{ route('lease.singlerenew',$id) }}"
            method="POST"> @csrf
        ...
        <div class="form-group row">
            <div class="offset-sm-2 col-sm-10">
                <button type="submit" class="btn btn-primary" id="btn-renew-lease" value="{{ $title }}">
                    submit</button>
            </div>
        </div>
