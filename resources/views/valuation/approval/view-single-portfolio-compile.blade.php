...
<div class="container-fluid">
    ...
    <ol class="breadcrumb no-bg mb-1">
        ...
        <li class="breadcrumb-item"><a href="{{ route('valapp.listportcompile') }}">List</a></li>
    ...
    <div class="box box-block bg-white">
        <div class="d-flex flex-row justify-content-between">
            <div>
                ...
                <p class="font-90 text-muted mb-1">Check the items compiled</p>

            </div>
        </div>
        <form action="{{ route('valapp.sbtcompilrep') }}" method="POST" id="defaultform">@csrf
            <div>
                <button type="submit" class="btn btn-primary" id="btn-multi-select">compile
            ...
            <div class="form-group row">
                <div class="offset-sm-2 col-sm-10">
                    <a onclick="closeportfolio(this); return false;"
                        class="btn btn-success btn-sm" href="{{route('valapp.closeport', $portfolioid)}}"
                        title="close"><i class="ti-check mr-0-5"></i>close portfolio</a>
                </div>
            </div>
