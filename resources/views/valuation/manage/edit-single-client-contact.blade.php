...
$description = 'update next of contact details...';
...
<div class="container-fluid">
    ...
    <ol class="breadcrumb no-bg mb-1">
        ...
        <li class="breadcrumb-item"><a href="{{ route('valman.editclient',$id) }}">View/Edit</a></li>
    ...
    <div class="box box-block bg-white">
        ...
        <form class="form-material material-primary" method="POST" id="defaultform"
            action="{{ route('valman.editclientdet', [$id,$contactid]) }}">@csrf

            <div id="corporategroup">
                <div class="form-group row">
                    <label for="CompanyName" class="col-sm-2 form-control-label">Client Name</label>
                    <div class="col-sm-4">
            ...
            <div class="form-group row">
                ...
                <div class="offset-sm-2 col-sm-10">
                    <button type="submit" class="btn btn-primary" id="btn-add-client-contact">submit</button>
                </div>
                @endif
            </div>
