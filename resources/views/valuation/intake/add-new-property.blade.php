...
<div class="container-fluid">
    ...
    <div class="box box-block bg-white">
        ...
        <form class="form-material material-primary" id="defaultform" method="POST"
            action="{{ route('valin.createprop') }}"> @csrf
            <div class="form-group row">
                ...
                <small id="propertyclientnamecheck" style="color: red;">required</small>
            </div><br />
            <h5>Property Details </h5>
            <div class="table-responsive" style="margin-top: 15px;">
                <table class="table table-bordered table-hover" id="addpropertyitem">
                    <thead>
                        <tr>
                    ...
                    <tbody id="">
                        <tr>
                            ...
                            <td align="center" colspan="2">
                                <input id="add-new-property-item" class="btn btn-info" name="submit-new-property"
