            ...
            <div class="custom-scroll custom-scroll-dark">
                <div class="to-content">
                    ...
                    <div class="to-material">
                        <div class="tom-checkbox"><input name="material-design" type="checkbox" class="js-switch"
                                data-size="small" data-color="#20b9ae"></div>
            ...
            <nav class="navbar navbar-light">
                <div class="navbar-left">
                    <a class="navbar-brand" href="index.php">
                        <img src="img/logo/601102IMG_5264.png" class="logo">
                    </a>
       ...
       <i class="ti-arrow-left"></i>
                    ...
                    <div class="header-form float-md-left ml-md-2">
                        <form name="quick_search" method="get" action="invoice.php">
                            <input type="text" class="form-control b-a quick_invoice_search"
            ...
            <div class="content-area py-1">
                <div class="container-fluid">
                    ...
                    <div class="box box-block bg-white">
                        <h5>Add Supplier</h5>
                        <p class="font-90 text-muted mb-1"> use this form to add supplier to database..</p>
                        <form class="form-material material-primary" id="addsupplier">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Suppliers <i
                                        class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="supplier_name"
                                        name="supplier_name" placeholder="Suppliers" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="offset-sm-2 col-sm-10">
                                    <button type="submit" class="btn btn-primary" id="btn-submit"
                                        value="Add Supplier">Add Supplier</button>
