...
<head>
    ...
    <style>
        ...
        .footer {
            ...
            border-top: 1px solid #000; /* Top border for the footer */
        }
        .company-name {
            text-align: right;
            font-weight: bold;
...
<body>
<table id="firsttable">
    <tr><td></td><td class="company-name">Technologies Technologies</td></tr>
    <tr><td><strong>{{$invoicetitle}}<strong></td>
        <td class="right-cell"><img src="https://intpro.co.zw/wp-content/uploads/2023/02/newlogo2.png" class="logo"></td> </tr>
</table>
<table id="addresstable"><tr><td><strong>Attention:</strong> {{$tenantname}}<br>{{$propdesc}}
