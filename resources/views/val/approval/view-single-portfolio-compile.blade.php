    ...
    @section('content')
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb no-bg mb-1">
                ...
                <li class="breadcrumb-item"><a href="{{ route('valapp.listportcomp') }}">List</a></li>
            ...
            <div class="box box-block bg-white">
                ...
                <form action="{{ route('valapp.sbtcompil') }}" method="POST" id="defaultform">@csrf
                    <div>
                ...
                <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        class="btn btn-success btn-sm" href="{{route('valapp.portclose', $portfolioid)}}"
