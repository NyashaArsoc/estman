...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb no-bg mb-1">
            ...
            <li class="breadcrumb-item"><a href="{{route('invoice.listfailed')}}">List Failed</a></li>
            <li class="breadcrumb-item active">{{ $title }}</li>
        </ol>
        <div class="box box-block bg-white">
            <h5>{{ $invoice->currencycode.' - '.$title }}
                <span class="badge badge-pill bg-danger badge-secondary'">
                    failed</span></h5>
