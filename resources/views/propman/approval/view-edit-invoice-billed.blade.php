                    ...
                    <tbody>@php $count=1;@endphp
                        <tr>
                            ...
                            <td><input type="text" class="form-control" id="rental"
                                ...
                                <small id="propitemrentcheck" style="color: red;"> </small>
                            </td>
                        </tr>
                        <tr>
                            <td>{{$count ++}}</td>
                            ...
                            <td><input type="text" class="form-control" id="rateslevies"
                                ...
                                <small id="propitemratecostcheck" style="color: red;"> </small>
                            </td>
                        </tr>
                        <tr>
                            <td>{{$count ++}}</td>
                            ...
                            <td><input type="text" class="form-control" id="operationcosts"
                                ...
                                <small id="propitemoperationcostcheck" style="color: red;"> </small>
                            </td>
                        </tr>
                        <tr>
                            <td>{{$count ++}}</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <small id="propitemtotalbilledcheck" style="color: rgb(218, 12, 12));"> </small>
                            </td>
                        </tr>
                    </tbody>
                </table>
