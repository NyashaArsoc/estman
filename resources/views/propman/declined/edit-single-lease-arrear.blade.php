@php
$title = 'Edit Lease Arrear';
$description = 'update lease details...';
$id= Crypt::encrypt($arrear->id);
...
<div class="container-fluid">
    ...
    <div class="box box-block bg-white">
        ...
        <form class="form-material material-primary" method="POST" id="defaultform"
            action="{{ route('propdec.uptleaprearrear', [$id,$lid]) }}">@csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <option value="{{ $arrear->currencycode }}">{{ $arrear->currencycode }}</option>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="leaseratescost"
                        name="amount" value="{{ number_format($arrear->balrent,2) ?? ''}}">
