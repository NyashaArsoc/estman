@php
$title = 'Edit Lease Prepayment';
$description = 'update lease details...';
$id= Crypt::encrypt($prepay->id);
$lid= Crypt::encrypt($lease->id);
@endphp
@extends('layout.no-menu-layout')
@section('title', 'Edit Prepay')
...
<div class="container-fluid">
    ...
    <ol class="breadcrumb no-bg mb-1">
        ...
        <li class="breadcrumb-item"><a href="{{ route('propdec.editviewlea',$lid) }}">View/Edit</a></li>
    ...
    <div class="box box-block bg-white">
        ...
        <form class="form-material material-primary" method="POST" id="defaultform"
            action="{{ route('propdec.uptleaprepay', [$id,$lid]) }}">@csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    ...
                    <option value="{{ $prepay->currencycode }}">{{ $prepay->currencycode }}</option>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control" id="leaseratescost"
                        name="amount" value="{{ number_format($prepay->balance,2) ?? ''}}">
